...
os.environ['CUTCLIPS_STORAGE']=str(ROOT/'tests/artifacts/topfive-ui')
...
from api import db
from cutclips.topfive import TopFive,render_topfive,ffmpeg
from cutclips.editor import atomic_json
db.init()
if not db.list_jobs():
    ...
    folder=Path(os.environ['CUTCLIPS_STORAGE'])/'jobs'/job
